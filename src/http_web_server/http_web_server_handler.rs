...
pub struct HttpWebServerHandler
{
}

impl HttpWebServerHandler
{
    /// Returns new HttpWebServerHandler
    pub fn new() -> HttpWebServerHandler
    {
        HttpWebServerHandler{}
    }
    ...
    /// # Argumnets
    /// 
    /// * `stream` - A mutable TcpStream that is the stream to the client
